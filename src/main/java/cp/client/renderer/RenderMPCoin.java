...
public class RenderMPCoin<T extends Entity> extends Render<T>
{
	private static final ResourceLocation tex = new ResourceLocation("mceconomy3","textures/items/mp_coin.png");

    public RenderMPCoin(RenderManager renderManager)
    {
		super(renderManager);
	}
