...
public class ItemCashingAxe extends ItemAxe implements IHasModel, ICashingTool
{
	private final int useMP;
	private boolean canDestroy;

	public ItemCashingAxe(String name, Item.ToolMaterial material)
	{
		super(material, material.getAttackDamage() + 6.0F, -3.1F);
